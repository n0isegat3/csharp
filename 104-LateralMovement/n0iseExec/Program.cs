...
namespace n0iseExec
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            if (args.Length != 3)
            {
                Console.WriteLine("Usage:n0iseExec.exe [Target] [Service] [ExistingBinaryToRun]");
                Console.WriteLine("Example: n0iseExec.exe targetServer01 SensorService executable123.exe");
                return;
            }
